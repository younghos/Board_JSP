	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<form class="form-horizontal" role="form" action="/noticeInsert" method="post" id="frm" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="noticeName" name="noticeName" placeholder="게시글 제목">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="button" id="savebutton" class="btn btn-default" value="게시글 등록" />
						</div>
					</div>
